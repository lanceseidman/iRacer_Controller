...
namespace Arduino2WP8
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        */
        ...
        private string SPEED = "7"; // Store Speed; Cruise by Default
        ...
        {
            BT2Arduino_Send("\x1"+ SPEED);
        }

        private void btnLeft_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x5" + SPEED);
        }

        private void btnRight_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x6" + SPEED);
        }


        private void btnDown_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x2" + SPEED);
        }

        private void btnCruise_Tap_1(object sender, GestureEventArgs e)
        {
            SPEED = "7";
        }

        private void btnSlow_Tap_1(object sender, GestureEventArgs e)
        {
            SPEED = "5";
        }

        private void btnFast_Tap_1(object sender, GestureEventArgs e)
        {
            SPEED = "C";
        }

        private void btnSFast_Tap_1(object sender, GestureEventArgs e)
        {
            SPEED = "F";
        }

        private void btnLUp_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x5" + SPEED);
        }

        private void btnRUp_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x6" + SPEED);
        }

        private void btnDRight_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x8" + SPEED);
        }

        private void btnLDown_Tap_1(object sender, GestureEventArgs e)
        {
            BT2Arduino_Send("\x7" + SPEED);
        }
